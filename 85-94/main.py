...
while True:
    ...
    if globalvariables.messageID == 0:
        ...
        showMessage(7,1,globalvariables.message6)
    elif globalvariables.messageID == 7:
        showMessage(8,1,globalvariables.message7)
    elif globalvariables.messageID == 8:
        showMessage(9,1,globalvariables.message8)
    elif globalvariables.messageID == 9:
        showMessage(0,1,globalvariables.message9)
